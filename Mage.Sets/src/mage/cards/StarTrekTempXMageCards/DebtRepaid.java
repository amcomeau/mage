 ...
 * @author amcomeau
 */
public final class DebtRepaid extends CardImpl {

    public DebtRepaid(UUID ownerId, CardSetInfo setInfo) {
        ...
        // When Debt Repaid enters the battlefield, all damage that would be dealt this turn to you and permanents you control is dealt to enchanted creature instead.
        this.addAbility(new EntersBattlefieldTriggeredAbility(new DebtRepaidReplacementEffect(), false));
    ...
    private DebtRepaid(final DebtRepaid card) {
        super(card);
    }

    @Override
    public DebtRepaid copy() {
        return new DebtRepaid(this);
    }
}

class DebtRepaidReplacementEffect extends ReplacementEffectImpl {

    DebtRepaidReplacementEffect() {
    ...
    DebtRepaidReplacementEffect(final DebtRepaidReplacementEffect effect) {
        super(effect);
    }
    ...
    @Override
    public DebtRepaidReplacementEffect copy() {
        return new DebtRepaidReplacementEffect(this);
    }
}
